# Cortex API Parity Matrix (`neuroclient`)
...
| `unsubscribe` | <https://emotiv.gitbook.io/cortex-api/data-subscription/unsubscribe> | `unsubscribe_streams`, `streams::unsubscribe`, resilient wrapper | `match` | Per-stream outcomes preserve routes that fail to unsubscribe. |
